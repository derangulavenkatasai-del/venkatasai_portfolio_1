...
// DYNAMIC PDF GENERATION FOR RESUME DOWNLOAD
function downloadResumePDF() {
    const resumeHTML = `
    <div style="font-family: Arial, sans-serif; padding: 30px; color: #1a1a1a; line-height: 1.5; font-size: 13px;">
        <div style="text-align: center; border-bottom: 2px solid #0284c7; padding-bottom: 12px; margin-bottom: 18px;">
            <h1 style="margin: 0; font-size: 24px; color: #0284c7; text-transform: uppercase;">VENKATA SAI DERANGULA</h1>
        ...
        <div style="margin-bottom: 16px;">
            <h2 style="font-size: 14px; color: #0284c7; border-bottom: 1px solid #e5e7eb; padding-bottom: 4px; margin-bottom: 8px; text-transform: uppercase;">Professional Summary</h2>
        ...
        <div style="margin-bottom: 16px;">
            <h2 style="font-size: 14px; color: #0284c7; border-bottom: 1px solid #e5e7eb; padding-bottom: 4px; margin-bottom: 8px; text-transform: uppercase;">Education</h2>
        ...
        <div style="margin-bottom: 16px;">
            <h2 style="font-size: 14px; color: #0284c7; border-bottom: 1px solid #e5e7eb; padding-bottom: 4px; margin-bottom: 8px; text-transform: uppercase;">Work Experience</h2>
            ...
            <div style="margin-bottom: 12px;">
                ...
                <ul style="margin: 4px 0 0 18px; padding: 0; color: #374151;">
        ...
        <div style="margin-bottom: 16px;">
            <h2 style="font-size: 14px; color: #0284c7; border-bottom: 1px solid #e5e7eb; padding-bottom: 4px; margin-bottom: 8px; text-transform: uppercase;">Technical Skills</h2>
            <ul style="margin: 4px 0 0 18px; padding: 0; color: #374151;">
        ...
        <div style="margin-bottom: 16px;">
            <h2 style="font-size: 14px; color: #0284c7; border-bottom: 1px solid #e5e7eb; padding-bottom: 4px; margin-bottom: 8px; text-transform: uppercase;">Projects</h2>
        ...
        <div style="margin-bottom: 16px;">
            <h2 style="font-size: 14px; color: #0284c7; border-bottom: 1px solid #e5e7eb; padding-bottom: 4px; margin-bottom: 8px; text-transform: uppercase;">Certifications</h2>
            <ul style="margin: 4px 0 0 18px; padding: 0; color: #374151;">
        ...
        <div>
            <h2 style="font-size: 14px; color: #0284c7; border-bottom: 1px solid #e5e7eb; padding-bottom: 4px; margin-bottom: 8px; text-transform: uppercase;">Declaration</h2>
